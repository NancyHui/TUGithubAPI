...
class Branches(RestClient):
    ...
    def add_required_signatures_of_protected_branch(self, owner, repo, branch, **kwargs):
        ...
        :param branch: branch
        """
        return self.post('/repos/{}/{}/branches/{}/protection/required_signatures'.format(owner, repo, branch), **kwargs)
    ...
    def remove_user_restrictions_of_protected_branch(self, owner, repo, branch, **kwargs):
        ...
        :param branch: branch
        """
        return self.delete('/repos/{}/{}/branches/{}/protection/restrictions/users'.format(owner, repo, branch),
                           **kwargs)